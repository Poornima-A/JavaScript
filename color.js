...
(async function changeButtonColor() {
    ...
    try {
        ...
        await driver.get('https://www.tutorialspoint.com/selenium/practice/dynamic-prop.php');  // Replace with your page URL

        // Find the button element by its ID
        let button = await driver.findElement(By.id('colorChange')); // Replace with actual button ID
